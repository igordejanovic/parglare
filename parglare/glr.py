...
class GLRParser(Parser):
    ...
    def __init__(self, grammar, start_production=1, actions=None,
                 ...
                 layout=False, position=False, prefer_shifts=None,
        ...
        super(GLRParser, self).__init__(
            ...
            build_tree=build_tree, call_actions=call_actions, tables=tables,
            layout=layout, position=position, prefer_shifts=prefer_shifts,
